...
This project is a simple educational Streamlit web app that conceptually explores how physicochemical properties of biomolecules — such as charge, hydrophobicity, intrinsic disorder, and molecular length — might influence their propensity to form biomolecular condensates.
...
Uses a simple logistic regression model to estimate condensate formation likelihood.

Displays real-time predictions with confidence scores.

Serves as an introductory example for how machine learning can support hypothesis-building in biological systems.
